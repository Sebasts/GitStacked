...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `loginUserType` ENUM('USER', 'ADMIN') NOT NULL COMMENT 'user type is used as ‚Äòadmin‚Äô or ‚Äònormal user‚Äô, where admin can edit exercises.\n\n',
...
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (4, 'Biceps Curls With Dumbbell', 'Hold two barbells| the arms are streched| the hands are on your side| the palms face inwards. Bend the arms and bring the weight with a fast movement up. At the same time| rotate your arms by 90 degrees at the very beginning of the movement. At the highest point| rotate a little the weights further outwards. Without a pause| bring them down| slowly.', 'https://wger.de/media/exercise-images/81/Biceps-curl-2.png.200x200_q85.png', 15, 'ARMS');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (5, 'Dips', 'Hold onto the bars at a narrow place (if they are not parallel) and press yourself up| but don\'t stretch the arms completely| so the muscles stay during the whole exercise under tension. Now bend the arms and go down as much as you can| keeping the elbows always pointing back| At this point| you can make a short pause before repeating the movement.', 'https://wger.de/media/exercise-images/82/Tricep-dips-2-2.png.200x200_q85.png', 15, 'ARMS');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (6, 'Dips Between Two Benches', 'Put two benches so far appart| that you can hold onto one with your hands and are just able to reach the other with your feet. The legs stay during the exercise completely stretched. With your elbows facing back| bend them as much as you can. Push yourself up| but don\'t stretch out the arms.', 'https://wger.de/media/exercise-images/83/Bench-dips-2.png.200x200_q85.png', 15, 'ARMS');
...
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (8, 'Hammercurls', 'Hold two dumbbells and sit on a bench with a straight back| the shoulders are slightly rolled backwards. Your pals point to your body. Bend the arms and bring the weight up with a fast movement. Don\'t rotate your hands| as with the curls. Without any pause bring the dumbbell down with a slow| controlled movement', 'https://wger.de/media/exercise-images/86/Bicep-hammer-curl-2.png.200x200_q85.png', 15, 'ARMS');
...
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (11, 'Push Ups', 'Start with your body streched| your hands are shoulder-wide appart on the ground. Push yourself off the ground till you strech your arms. The back is always straight and as well as the neck (always look to the ground). Lower yourself to the initial position and repeat.', 'https://wger.de/media/exercise-images/195/Push-ups-1.png.200x200_q85.png', 15, 'ARMS');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (12, 'Dumbbell Lunges Walking', 'Take two dumbbells in your hands| stand straight| feet about shoulder wide. Take one long step so that the front knee is approximately forming a right angle. The back leg is streched| the knee is low but doesn\'t touch the ground. \"Complete\" the step by standing up and repeat the movement with the other leg.', 'https://wger.de/media/exercise-images/113/Walking-lunges-4.png.200x200_q85.jpg', 15, 'LEGS');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (13, 'Front Squats', 'From rack with barbell upper chest height| position bar in front of shoulders. Cross arms and place hands on top of barbell with upper arms parallel to floor. Dismount bar from rack. Squat down by bending hips back while allowing knees to bend forward| keeping back straight and knees pointed same direction as feet.', 'https://wger.de/media/exercise-images/191/Front-squat-2-857x1024.png.200x200_q85.png', 15, 'LEGS');
...
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (19, ' Squats', 'Make sure you have put the barbell at a height where you can comfortably take it out and put it back in. The bar is somewhat lower than your shoulders| the feet are quite apart and point out| the head is in your neck and looks up| The chest is out', 'https://wger.de/media/exercise-images/111/Wide-stance-squat-1.gif.200x200_q85.jpg', 15, 'LEGS');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (20, 'Crunches', 'Lay down on your back a soft surface| the feet are on the floor. Ask a partner or use some other help (barbell| etc.) to keep them fixed| your hands are behind your head. From this position move your upper body up till your head or elbows touch your knees. Do this movement by rolling up your back.', 'https://wger.de/media/exercise-images/91/Crunches-2.png.200x200_q85.png', 15, 'ABS');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (21, 'Lying Leg Raises', 'Lay down on a bench and hold onto the recliner with your hands to keep you stable. Hold your legs straight and lift them till they make an angle of about 45°. Make a short pause of 1 sec. and go slowly down to the initial position. To increase the intensity you can make a longer pause of 7 sec. every 5th time.', 'https://wger.de/media/exercise-images/125/Leg-raises-1.png.200x200_q85.png', 15, 'ABS');
...
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (23, 'Side Crunch', 'Hold weight in one hand. Bend side ways to the knee. Pull upo to upright position using your obliquus.', 'https://wger.de/media/exercise-images/176/Cross-body-crunch-2.png.200x200_q85.png', 15, 'ABS');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (24, 'Bench Press', 'Lay down on a bench| the bar should be directly above your eyes| the knees are somewhat angled and the feet are firmly on the floor. Concentrate| breath deeply and grab the bar more than shoulder wide. Bring it slowly down till it briefly touches your chest at the height of your nipples. Push the bar up. If you train with a high weight it is advisable to have a spotter that can help you up if you can\'t lift the weight on your own.  With the width of the grip you can also control which part of the chest is trained more by using a wide grip: outer chest muscles or narrow grip: inner chest muscles and triceps|', 'https://wger.de/media/exercise-images/192/Bench-press-2.png.200x200_q85.png', 15, 'CHEST');
...
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (26, 'Butterfly', 'Sit on the butterfly machine| the feet have a good contact with the floor| the upper arms are parallel to the floor. Press your arms together till the handles are practically together (but aren\'t!). Go slowly back. The weights should stay all the time in the air.', 'https://wger.de/media/exercise-images/98/Butterfly-machine-1.png.200x200_q85.jpg', 15, 'CHEST');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (27, 'Decline Bench Press Barbell', 'Lay down on a decline bench| the bar should be directly above your eyes| the knees are somewhat angled and the feet are firmly on the floor. Concentrate| breath deeply and grab the bar more than shoulder wide. Bring it slowly down till it briefly touches your chest at the height of your nipples. Push the bar up.', 'https://wger.de/media/exercise-images/100/Decline-bench-press-2.png.200x200_q85.jpg', 15, 'CHEST');
...
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (37, 'Lateral Raises', 'In a standing position - with your feet firmly placed for balance; grasp a dumbbell in each hand. Keep the dumbbells at hanging straight down at your sides. Simultaneously| raisethe dumbbells directly to your sides. Be sure to turn your palm facing down| and have your elbows slightly bent.', 'https://wger.de/media/exercise-images/148/lateral-dumbbell-raises-large-1.png.200x200_q85.jpg', 15, 'SHOULDER');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (38, 'Shoulder Press| Barbell', 'Sit on a bench| the back rest should be almost vertical. Take a barbell with a shoulder wide grip and bring it up to chest height. Press the weight up| but don\'t stretch the arms completely. Go slowly down and repeat.', 'https://wger.de/media/exercise-images/119/seated-barbell-shoulder-press-large-2.png.200x200_q85.jpg', 15, 'SHOULDER');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (39, 'Shoulder Press| Dumbbells', 'Sit on a bench| the back rest should be almost vertical. Take two dumbbells and bring them up to shoulder height| the palms and the elbows point during the whole exercise to the front. Press the weights up| at the highest point they come very near but don\'t touch. Go slowly down and repeat.', 'https://wger.de/media/exercise-images/123/dumbbell-shoulder-press-large-2.png.200x200_q85.jpg', 15, 'SHOULDER');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (40, 'Shoulder Press| on Machine', 'Sit down on the Shoulder Press Machine and select the weight. Grab the handles to your sides as you keep the elbows bent and in line with your torso.', 'https://wger.de/media/exercise-images/152/seated-shoulder-press-machine-large-2.png.200x200_q85.jpg', 15, 'SHOULDER');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (41, 'Shrugs| Barbells', 'Take a barbell and stand with a straight body| the arms are hanging freely in front of you. Lift from this position the shoulders as high as you can| but don\'t bend the arms during the movement. On the highest point| make a short pause of 1 or 2 seconds before returning slowly to the initial position.', 'https://wger.de/media/exercise-images/150/Barbell-shrugs-2.png.200x200_q85.png', 15, 'SHOULDER');
INSERT INTO `exercise` (`id`, `name`, `desc`, `imageUrl`, `calories`, `muscleGroup`) VALUES (42, 'Shrugs| Dumbbells', 'Stand with straight body| the hands are hanging freely on the side and hold each a dumbbell. Lift from this position the shoulders as high as you can| but don\'t bend the arms during the movement. On the highest point| make a short pause of 1 or 2 seconds before returning slowly to the initial position.', 'https://wger.de/media/exercise-images/151/Dumbbell-shrugs-1.png.200x200_q85.jpg', 15, 'SHOULDER');
